...
public class RobotMap {
    ...
    //Arm potentiometers (AI pins)
    public static final int ARM_POTENTIOMETER_JOINT_0 = 0;
    public static final int ARM_POTENTIOMETER_JOINT_1 = 1;
    public static final int ARM_POTENTIOMETER_JOINT_2 = 2;
